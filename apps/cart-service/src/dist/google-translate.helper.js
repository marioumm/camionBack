...
var GoogleTranslateHelper = /** @class */ (function () {
    ...
    GoogleTranslateHelper.translate = function (text, targetLang, sourceLang) {
        if (sourceLang === void 0) { sourceLang = 'en'; }
        return __awaiter(this, void 0, Promise, function () {
            var cacheKey, cached, response, translatedText, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Google Translate Error:', error_1.message);
                        return [2 /*return*/, text];
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, response.data.data.translations.map(function (t) { return t.translatedText; })];
                    case 3:
                        error_2 = _a.sent();
                        console.error('Google Translate Batch Error:', error_2.message);
                        return [2 /*return*/, texts];
                    case 4: return [2 /*return*/];
                }
            });
